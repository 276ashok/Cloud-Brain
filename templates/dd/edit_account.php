...
$rdate=date("d-m-Y");
$qry2=mysqli_query($connect,"select * from vb_account where id='$id'");
...
mysqli_query($connect,"update vb_account set bank='$bank1',branch='$branch1',account='$account1',pinno='$pinno1',cardno='$cardno1',acpass='$acpass1',rid=$rid where id=$id");
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="col-md-6">
								...
								<label>Bank</label>
									<input class="check-form" type="text" name="bank" placeholder="" value="<?php echo fnDecrypt($row2['bank'],$key); ?>">
							...
							<div class="col-md-6">
								<div class="form-group">
								<label>Branch</label>
									<input class="check-form" type="text" name="branch" placeholder="" value="<?php echo fnDecrypt($row2['branch'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-6">
								...
								<label>Account Number</label>
									<input class="check-form" type="text" name="account" placeholder="" value="<?php echo fnDecrypt($row2['account'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-6">
								...
								<label>Pin Number</label>
									<input class="check-form" type="text" name="pinno" placeholder="" value="<?php echo fnDecrypt($row2['pinno'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-6">
								...
								<label>Card Number</label>
									<input class="check-form" type="text" name="cardno" placeholder="" value="<?php echo fnDecrypt($row2['cardno'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								<label>Accunt Password</label>
									<input class="check-form" type="password" name="acpass" placeholder="" value="<?php echo fnDecrypt($row2['acpass'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
			  ...
			  ?>
			  <option value="<?php echo $rr2['id']; ?>" <?php if($rr2['id']==$row2['rid']) echo "selected"; ?>><?php echo "ID:".$rr2['id']." - ".$rname; ?></option>
			  <?php
			  }
			  ?>
              </select>
