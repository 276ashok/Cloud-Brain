...
$id=$_REQUEST['id'];
$qry2=mysqli_query($connect,"select * from vb_email where id='$id'");
...
$ins=mysqli_query($connect,"update vb_email set email='$email1',pass='$pass1',rid=$rid where id=$id");					
...
<body>
	...
	<section class="contact-page spad">
		<div class="container">
		<h3>Update E-mail ID Information</h3>
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<label>Password</label>
									<input class="check-form" type="text" name="pass" placeholder="" value="<?php echo fnDecrypt($row2['pass'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
