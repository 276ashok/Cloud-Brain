...
if(isset($btn))
{
$qry = mysqli_query($connect,"select max(id) as maxid from vb_email");
...
$ins=mysqli_query($connect,"insert into vb_email(id,uname,email,pass,rdate) values($id,'$uname','$email1','$pass1','$rdate1')");					
...
{
$did=$_REQUEST['did'];
mysqli_query($connect,"delete from vb_email where id=$did");
header("location:ac_email.php");
}
...
<body>
	...
	<section class="contact-page spad">
		<div class="container">
		<h3>Your E-mail ID Information</h3>
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="col-md-8">
							...
							<div class="col-md-8">
								...
								<label>Password</label>
									<input class="check-form" type="password" name="pass" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
				...
				<div class="col-lg-6 mt-5 mt-lg-0">
					...
					<?php
		  $q1=mysqli_query($connect,"select * from vb_email where uname='$uname'");
		  ...
		  ?>
						<div class="row">
							...
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['pass'],$key); ?>
							</div>
							<div class="col-md-6">
								Relative
							</div>
			  ...
			  ?>
							...
							<p align="right"><a href="edit_email.php?act=email&id=<?php echo $r1['id']; ?>">Edit</a> |
			  <a href="ac_email.php?act=del&did=<?php echo $r1['id']; ?>" onClick="return del()">Delete</a></p>
							</div>
						</div>
