...
$sk=fnDecrypt($row1['secret_key'],$key);
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					...
					<h3>Decrypt the Information</h3>
					<div class="col-md-8">
								<div class="form-group">
								<label>Secret Key</label>
									<input class="check-form" type="password" name="secret" placeholder="" required>
									<span><i class="ti-check"></i></span>
								</div>
							</div>
					<div class="col-md-12">
								<button type="submit" name="btn" class="site-btn sb-gradients mt-4" onClick="return validate()">Decryption</button>
							</div>
					</form>
