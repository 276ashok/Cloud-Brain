...
$qry2=mysqli_query($connect,"select * from vb_relative where id='$id'");
...
mysqli_query($connect,"update vb_relative set name='$name1',relation='$relation1',mobile='$mobile1',email='$email1' where id=$id");					
...
<body>
	...
	<section class="contact-page spad">
		<div class="container">
		<h3>Update Relatives Information</h3>
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="col-md-6">
								...
								<label>Name</label>
									<input class="check-form" type="text" name="name" placeholder="" value="<?php echo fnDecrypt($row2['name'],$key); ?>">
					...
					<div class="col-md-6">
								...
								<label>Relation</label>
									<input class="check-form" type="text" name="relation" placeholder="" value="<?php echo fnDecrypt($row2['relation'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
					<div class="col-md-6">
								...
								<label>Mobile No.</label>
									<input class="check-form" type="text" name="mobile" maxlength="10" placeholder="" value="<?php echo fnDecrypt($row2['mobile'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
					<div class="col-md-6">
								<div class="form-group">
								<label>E-mail</label>
									<input class="check-form" type="text" name="email" placeholder="" value="<?php echo fnDecrypt($row2['email'],$key); ?>">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
