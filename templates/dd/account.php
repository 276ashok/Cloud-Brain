...
if(isset($btn))
{
$qry = mysqli_query($connect,"select max(id) as maxid from vb_account");
$rs=mysqli_fetch_array($qry);
$id = $rs['maxid']+1;

$bank1=fnEncrypt($bank,$key);
$branch1=fnEncrypt($branch,$key);
$account1=fnEncrypt($account,$key);
$pinno1=fnEncrypt($pinno,$key);
$cardno1=fnEncrypt($cardno,$key);
$acpass1=fnEncrypt($acpass,$key);
$rdate1=fnEncrypt($rdate,$key);
$ins=mysqli_query($connect,"insert into vb_account(id,uname,bank,branch,account,pinno,cardno,acpass,rdate) values($id,'$uname','$bank1','$branch1','$account1','$pinno1','$cardno1','$acpass1','$rdate1')");					
...
{
$did=$_REQUEST['did'];
mysqli_query($connect,"delete from vb_account where id=$did");
header("location:account.php");
}
...
<body>
	...
	<section class="contact-page spad">
		<div class="container">
		<h3>Your Bank Account Information</h3>
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="col-md-8">
								...
								<label>Bank</label>
									<input class="check-form" type="text" name="bank" placeholder="">
							...
							<div class="col-md-8">
								<div class="form-group">
								<label>Branch</label>
									<input class="check-form" type="text" name="branch" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-8">
								...
								<label>Account No.</label>
									<input class="check-form" type="text" name="account" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-8">
								...
								<label>PIN Number</label>
									<input class="check-form" type="text" name="pinno" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-8">
								...
								<label>Card Number</label>
									<input class="check-form" type="text" name="cardno" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
							<div class="col-md-8">
								...
								<label>Account Password</label>
									<input class="check-form" type="text" name="acpass" placeholder="">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
				...
				<div class="col-lg-6 mt-5 mt-lg-0">
					...
					<?php
		  $q1=mysqli_query($connect,"select * from vb_account where uname='$uname'");
		  ...
		  ?>
						<div class="row">
							...
							<div class="col-md-6">
									: <?php echo fnDecrypt($r1['bank'],$key); ?>
							</div>
							<div class="col-md-6">
								Branch
							</div>
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['branch'],$key); ?>
							</div>
							<div class="col-md-6">
								Account No.
							</div>
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['account'],$key); ?>
							</div>
							<div class="col-md-6">
								PIN Number
							</div>
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['pinno'],$key); ?>
							</div>
							<div class="col-md-6">
								Card Number
							</div>
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['cardno'],$key); ?>
							</div>
							<div class="col-md-6">
								Account Password
							</div>
							<div class="col-md-6">
								: <?php echo fnDecrypt($r1['acpass'],$key); ?>
							</div>
							<div class="col-md-6">
								Relative
							</div>
			  ...
			  ?>
							...
							<p align="right"><a href="edit_account.php?act=account&id=<?php echo $r1['id']; ?>">Edit</a> |
			  <a href="account.php?act=del&did=<?php echo $r1['id']; ?>" onClick="return del()">Delete</a></p>
							</div>
						</div>
