...
if(isset($btn))
{
$fname="U".$id.$_FILES['file']['name'];
move_uploaded_file($_FILES['file']['tmp_name'],"photo/".$fname);
$fname1=fnEncrypt($fname,$key);
mysqli_query($connect,"update vb_register set photo='$fname1' where uname='$uname'");
				...
				<div class="col-lg-8">
					...
					<div class="col-md-12">
								...
								<div class="form-group">
									<input class="check-form" type="file" name="file">
									<span><i class="ti-check"></i></span>
								</div>
							</div>
					<div class="col-md-12">
								<button type="submit" name="btn" class="site-btn sb-gradients mt-4" onClick="return validate()">Upload</button>
							</div>
					</form>
				</div>
