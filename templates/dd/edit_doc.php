...
$rdate=date("d-m-Y");
$qry2=mysqli_query($connect,"select * from vb_document where id='$id'");
...
mysqli_query($connect,"update vb_document set title='$title1',details='$details1',rid=$rid where id=$id");
				...
				<div class="col-lg-8">
					...
					<div class="col-md-6">
								...
								<label>Title of Document</label>
									<input class="check-form" type="text" name="title" placeholder="" value="<?php echo fnDecrypt($row2['title'],$key); ?>">
							...
							<div class="col-md-6">
								...
								<label>Details about document</label>
									<textarea name="details"><?php echo fnDecrypt($row2['details'],$key); ?></textarea>
									<span><i class="ti-check"></i></span>
								</div>
							</div>
